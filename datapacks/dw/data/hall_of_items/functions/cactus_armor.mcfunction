...
execute if entity @a[tag=toggle] run summon item -995 63 -26 {Item:{id:"minecraft:firework_star",Count:1b,tag:{Explosion:{Colors:[I;53248]}}},Age:-30000,Invulnerable:1b,PickupDelay:10124151,Tags:["item_model","model_cactus"]}
