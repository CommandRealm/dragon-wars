...
title @a[scores={ready=0},gamemode=adventure] actionbar [{"text":"","color":"light_purple"},{"text":"You will spectate.","italic":true,"color":"white"},{"text":" ("},{"score":{"objective":"n_ready","name":"$number"}},{"text":"/"},{"score":{"objective":"n_on","name":"$number"}},{"text":")"}]
title @a[scores={ready=1},gamemode=adventure] actionbar [{"text":"","color":"light_purple"},{"text":"You will play!","bold":true,"color":"light_purple"},{"text":" ("},{"score":{"objective":"n_ready","name":"$number"}},{"text":"/"},{"score":{"objective":"n_on","name":"$number"}},{"text":")"}]
