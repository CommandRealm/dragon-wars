kill @e[tag=hippeh]
summon minecraft:armor_stand -21 67.5 30 {Tags:["credits","hippeh"],NoBasePlate:1,ShowArms:1,Rotation:[-67.5f,0.0f],NoGravity:1,ArmorItems:[{},{},{},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:"HippehWizard"}}],Pose:{RightArm:[0.0f,0.0f,0.0f],RightLeg:[0.0f,0.0f,0.0f],LeftArm:[0.0f,0.0f,0.0f],LeftLeg:[0.0f,0.0f,0.0f],Head:[0.0f,0.0f,0.0f],Body:[0.0f,0.0f,0.0f]},Marker:1}
...
replaceitem entity @e[tag=hippeh] armor.feet golden_boots
replaceitem entity @e[tag=hippeh] armor.chest leather_chestplate{display:{color:6029316}}
