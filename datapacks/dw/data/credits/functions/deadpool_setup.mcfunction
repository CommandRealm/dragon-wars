...
item replace entity @e[tag=deadpool] armor.feet with leather_boots{display:{color:3223857}}
item replace entity @e[tag=deadpool] armor.chest with leather_chestplate{display:{color:6842472}}
item replace entity @e[tag=deadpool] armor.legs with leather_leggings{display:{color:13948116}}
