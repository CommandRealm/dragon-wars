...
replaceitem entity @s armor.legs leather_leggings{KillOnDeath:1,display:{color:53248,Name:'{"italic":false,"bold":true,"color":"dark_green","text":"Cactus Leggings"}'},Enchantments:[{id:"binding_curse",lvl:1},{id:"minecraft:thorns",lvl:1}],HideFlags:63,Unbreakable:1b}
replaceitem entity @s armor.feet leather_boots{KillOnDeath:1,display:{color:53248,Name:'{"italic":false,"bold":true,"color":"dark_green","text":"Cactus Boots"}'},Enchantments:[{id:"binding_curse",lvl:1},{id:"minecraft:thorns",lvl:1}],HideFlags:63,Unbreakable:1b}
