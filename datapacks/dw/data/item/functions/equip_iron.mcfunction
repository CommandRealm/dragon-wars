...
item replace entity @s armor.legs with iron_leggings{KillOnDeath:1,display:{Name:'{"italic":false,"bold":true,"color":"gray","text":"Iron Leggings"}'},Enchantments:[{id:"binding_curse",lvl:1}],HideFlags:63,Unbreakable:1b}
item replace entity @s armor.feet with iron_boots{KillOnDeath:1,display:{Name:'{"italic":false,"bold":true,"color":"gray","text":"Iron Boots"}'},Enchantments:[{id:"binding_curse",lvl:1}],HideFlags:63,Unbreakable:1b}
