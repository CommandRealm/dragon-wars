...
item replace entity @s armor.legs with chainmail_leggings{Enchantments:[{id:"projectile_protection",lvl:4}],KillOnDeath:1,display:{Name:'{"italic":false,"bold":true,"color":"dark_gray","text":"Chainmail Leggings"}'},Enchantments:[{id:"binding_curse",lvl:1}],HideFlags:63,Unbreakable:1b}
item replace entity @s armor.feet with chainmail_boots{Enchantments:[{id:"projectile_protection",lvl:4}],KillOnDeath:1,display:{Name:'{"italic":false,"bold":true,"color":"dark_gray","text":"Chainmail Boots"}'},Enchantments:[{id:"binding_curse",lvl:1}],HideFlags:63,Unbreakable:1b}
