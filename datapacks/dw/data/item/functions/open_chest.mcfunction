...
execute if entity @e[tag=item_spawn,name="Trident",tag=selected_item] run give @s trident{HideFlags:63,echest:1,Unbreakable:1b,Enchantments:[{id:"minecraft:loyalty",lvl:5}],display:{Lore:['{"text":"A trident enchanted with loyalty V.","italic":false,"color":"dark_aqua"}','[{"text":"6","color":"white","italic":false},{"text":" Attack","color":"gray"},{"text":" Damage","color":"dark_red"}]'],Name:'{"italic":false,"bold":true,"color":"dark_aqua","text":"Trident"}'},AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Amount:5,Operation:0, UUID:[I; 100, 100, 100, 100],Slot:"mainhand"},{AttributeName:"generic.attack_speed",Name:"generic.attack_speed",Amount:1024,Operation:0, UUID:[I; 101, 101, 101, 101],Slot:"mainhand"}]}
...
execute if entity @e[tag=item_spawn,name="Iron Armor",tag=selected_item] run give @s firework_star{ArmorType:0,Explosion:{Colors:[I;16777215]},HideFlags:63,echest:1,Dropable:1,Unbreakable:1b,display:{Lore:['{"text":"Drop to equip iron armor.","italic":false,"color":"gray"}'],Name:'[{"italic":false,"bold":true,"color":"gray","text":"Iron Armor"},{"text":" <","color":"dark_gray","bold":true,"italic":false},{"keybind":"key.drop","color":"gray","bold":false,"italic":false},{"text":">","color":"dark_gray","bold":true,"italic":false}]'}}

execute if entity @e[tag=item_spawn,name="Chain Armor",tag=selected_item] run give @s firework_star{ArmorType:1,Explosion:{Colors:[I;4934475]},HideFlags:63,echest:1,Dropable:1,Unbreakable:1b,display:{Lore:['{"text":"Drop to equip chainmail armor ","italic":false,"color":"dark_gray"}','{"text":"enchanted with projectile protection IV.","italic":false,"color":"dark_gray"}'],Name:'[{"italic":false,"bold":true,"color":"dark_gray","text":"Archery Protection Armor"},{"text":" <","color":"dark_gray","bold":true,"italic":false},{"keybind":"key.drop","color":"gray","bold":false,"italic":false},{"text":">","color":"dark_gray","bold":true,"italic":false}]'}}

execute if entity @e[tag=item_spawn,name="Ninja Outfit",tag=selected_item] run give @s firework_star{ArmorType:2,Explosion:{Colors:[I;5479591]},HideFlags:63,echest:1,Dropable:1,Unbreakable:1b,display:{Lore:['{"text":"Drop to equip leather armor that grants a speed buff.","italic":false,"color":"dark_aqua"}'],Name:'[{"italic":false,"bold":true,"color":"dark_aqua","text":"Ninja Armor"},{"text":" <","color":"dark_gray","bold":true,"italic":false},{"keybind":"key.drop","color":"gray","bold":false,"italic":false},{"text":">","color":"dark_gray","bold":true,"italic":false}]'}}
...
execute if entity @e[tag=item_spawn,name="TNT",tag=selected_item] run give @s tnt{HideFlags:63,echest:1,Dropable:1,Unbreakable:1b,display:{Lore:['{"text":"Drop to throw TNT.","italic":false,"color":"red"}'],Name:'[{"italic":false,"bold":true,"color":"red","text":"TNT"},{"text":" <","color":"dark_gray","bold":true,"italic":false},{"keybind":"key.drop","color":"gray","bold":false,"italic":false},{"text":">","color":"dark_gray","bold":true,"italic":false}]'}}

execute if entity @e[tag=item_spawn,name="Brewing Stand",tag=selected_item] run give @s brewing_stand{HideFlags:63,echest:1,Dropable:1,Unbreakable:1b,display:{Lore:['{"text":"Drop to gain a random potion effect.","italic":false,"color":"dark_purple"}'],Name:'[{"italic":false,"bold":true,"color":"dark_purple","text":"Risky Brew"},{"text":" <","color":"dark_gray","bold":true,"italic":false},{"keybind":"key.drop","color":"gray","bold":false,"italic":false},{"text":">","color":"dark_gray","bold":true,"italic":false}]'}}

execute if entity @e[tag=item_spawn,name="TP Beam",tag=selected_item] run give @s ender_eye{HideFlags:63,echest:1,Dropable:1,Unbreakable:1b,display:{Lore:['{"text":"Drop to shoot a laser that swaps places with other players.","italic":false,"color":"red"}'],Name:'[{"italic":false,"bold":true,"color":"red","text":"Swapper Beam"},{"text":" <","color":"dark_gray","bold":true,"italic":false},{"keybind":"key.drop","color":"gray","bold":false,"italic":false},{"text":">","color":"dark_gray","bold":true,"italic":false}]'}}

execute if entity @e[tag=item_spawn,name="Tornado Jump",tag=selected_item] run give @s feather{HideFlags:63,echest:1,Dropable:1,Unbreakable:1b,display:{Lore:['{"text":"Drop to gain levitation for 1 second.","italic":false,"color":"white"}'],Name:'[{"italic":false,"bold":true,"color":"white","text":"Tornado Jump"},{"text":" <","color":"dark_gray","bold":true,"italic":false},{"keybind":"key.drop","color":"gray","bold":false,"italic":false},{"text":">","color":"dark_gray","bold":true,"italic":false}]'}}
...
execute if entity @e[tag=item_spawn,name="Monster Horde",tag=selected_item] run give @s rotten_flesh{HideFlags:63,echest:1,Unbreakable:1b,display:{Lore:['{"text":"Drop to spawn a horde of monsters.","italic":false,"color":"dark_red"}'],Name:'[{"italic":false,"bold":true,"color":"dark_red","text":"Monster Horde"},{"text":" <","color":"dark_gray","bold":true,"italic":false},{"keybind":"key.drop","color":"gray","bold":false,"italic":false},{"text":">","color":"dark_gray","bold":true,"italic":false}]'}}

execute if entity @e[tag=item_spawn,name="Ice Mine",tag=selected_item] run give @s ice{HideFlags:63,echest:1,Unbreakable:1b,display:{Lore:['{"text":"Drop to create an ice trap.","italic":false,"color":"aqua"}'],Name:'[{"italic":false,"bold":true,"color":"aqua","text":"Ice Mine"},{"text":" <","color":"dark_gray","bold":true,"italic":false},{"keybind":"key.drop","color":"gray","bold":false,"italic":false},{"text":">","color":"dark_gray","bold":true,"italic":false}]'}} 3

execute if entity @e[tag=item_spawn,name="Time Bomb",tag=selected_item] run give @s chiseled_polished_blackstone{HideFlags:63,echest:1,Unbreakable:1b,display:{Lore:['{"text":"Drop to set a timed bomb.","italic":false,"color":"dark_gray"}'],Name:'[{"italic":false,"bold":true,"color":"dark_gray","text":"Time Bomb"},{"text":" <","color":"dark_gray","bold":true,"italic":false},{"keybind":"key.drop","color":"gray","bold":false,"italic":false},{"text":">","color":"dark_gray","bold":true,"italic":false}]'}}

execute if entity @e[tag=item_spawn,name="Levitation Blast",tag=selected_item] run give @s end_crystal{HideFlags:63,echest:1,Unbreakable:1b,display:{Lore:['{"text":"Drop to gain levitation before shooting a laser.","italic":false,"color":"#f9baff"}'],Name:'[{"italic":false,"bold":true,"color":"#f9baff","text":"Levitation Blast"},{"text":" <","color":"dark_gray","bold":true,"italic":false},{"keybind":"key.drop","color":"gray","bold":false,"italic":false},{"text":">","color":"dark_gray","bold":true,"italic":false}]'}}


execute if entity @e[tag=item_spawn,name="Vampiric Stake",tag=selected_item] run give @s wooden_sword{Unbreakable:1b,AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Amount:4,Operation:0, UUID:[I; 100, 100, 100, 100]},{AttributeName:"generic.attack_speed",Name:"generic.attack_speed",Amount:1024,Operation:0, UUID:[I; 101, 101, 101, 101]}],HideFlags:63,echest:1,display:{Lore:['{"text":"A buffed wooden sword that heals you after getting a kill.","italic":false,"color":"red"}','[{"text":"5","color":"white","italic":false},{"text":" Attack","color":"gray"},{"text":" Damage","color":"dark_red"}]'],Name:'{"text":"Vampiric Stake","color":"red","italic":false,"bold":true}'}}


# new 1.17 items
execute if entity @e[tag=item_spawn,name="Death Scythe",tag=selected_item] run give @s netherite_hoe{Unbreakable:1b,AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Amount:8,Operation:0, UUID:[I; 100, 100, 100, 100]},{AttributeName:"generic.attack_speed",Name:"generic.attack_speed",Amount:1024,Operation:0, UUID:[I; 101, 101, 101, 101]}],HideFlags:63,echest:1,display:{Lore:['{"text":"A powerful melee weapon that lowers the user\'s max health.","italic":false,"color":"gray"}','[{"text":"9","color":"white","italic":false},{"text":" Attack","color":"gray"},{"text":" Damage","color":"dark_red"}]'],Name:'[{"text":"Death\'s ","color":"dark_gray","italic":false,"bold":true},{"text":"Scythe","color":"gray"}]'}}

execute if entity @e[tag=item_spawn,name="Armor Breaker",tag=selected_item] run give @s iron_pickaxe{Unbreakable:1b,AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Amount:4,Operation:0, UUID:[I; 100, 100, 100, 100]},{AttributeName:"generic.attack_speed",Name:"generic.attack_speed",Amount:1024,Operation:0, UUID:[I; 101, 101, 101, 101]}],HideFlags:63,echest:1,display:{Lore:['{"text":"A weapon that breaks the armor of any player it hits.","italic":false,"color":"gold"}'],Name:'[{"text":"Armor ","color":"gray","italic":false,"bold":true},{"text":"Breaker","color":"gold"}]'}}

execute if entity @e[tag=item_spawn,name="Leaping Armor",tag=selected_item] run give @s firework_star{ArmorType:6,Explosion:{Colors:[I;4977989]},HideFlags:63,echest:1,Dropable:1,Unbreakable:1b,display:{Lore:['{"text":"Drop to equip leather armor that grants jump boost.","italic":false,"color":"gray"}'],Name:'[{"text":"Leaping ","color":"green","bold":true,"italic":false},{"italic":false,"bold":true,"color":"gray","text":"Armor"},{"text":" <","color":"dark_gray","bold":true,"italic":false},{"keybind":"key.drop","color":"gray","bold":false,"italic":false},{"text":">","color":"dark_gray","bold":true,"italic":false}]'}}

execute if entity @e[tag=item_spawn,name="Explosive Bow",tag=selected_item] run give @s bow{explosive_bow:1,HideFlags:63,echest:1,Unbreakable:1b,display:{Lore:['{"text":"A bow that explodes when it hits a player. Each shot uses up three arrows.","italic":false,"color":"gray"}'],Name:'[{"text":"Explosive ","color":"red","bold":true,"italic":false},{"italic":false,"bold":true,"color":"gray","text":"Bow"}]'}}

execute if entity @e[tag=item_spawn,name="Time Warp",tag=selected_item] run give @s clock{explosive_bow:1,HideFlags:63,echest:1,Unbreakable:1b,display:{Lore:['{"text":"Drop to warp to your position three seconds ago.","italic":false,"color":"dark_purple"}'],Name:'[{"text":"Time ","color":"gold","bold":true,"italic":false},{"italic":false,"bold":true,"color":"dark_purple","text":"Warp"},{"text":" <","color":"dark_gray","bold":true,"italic":false},{"keybind":"key.drop","color":"gray","bold":false,"italic":false},{"text":">","color":"dark_gray","bold":true,"italic":false}]'}}

execute if entity @e[tag=item_spawn,name="Firework Remover",tag=selected_item] run give @s snowball{explosive_bow:1,HideFlags:63,echest:1,Unbreakable:1b,display:{Lore:['{"text":"Clears fireworks from players near the projectile.","italic":false,"color":"dark_red"}'],Name:'[{"text":"Firework ","color":"gray","bold":true,"italic":false},{"italic":false,"bold":true,"color":"dark_red","text":"Remover"}]'}}
