...
item replace entity @s[advancements={custom/unlock_prefix=true}] enderchest.10 with name_tag{KillWhenDropped:1,display:{Name:'{"text":"Exclusive Prefix","color":"light_purple","italic":false,"bold":true}',Lore:['[{"text":"Unlocked!","italic":false,"color":"gold"}]']}}
...
item replace entity @s[advancements={custom/unlock_boost_particle=true}] enderchest.12 with netherite_ingot{KillWhenDropped:1,display:{Name:'{"text":"Exclusive Boost Particle","color":"light_purple","italic":false,"bold":true}',Lore:['[{"text":"Unlocked!","italic":false,"color":"gold"}]']}}
...
item replace entity @s[advancements={custom/unlock_sword_name=true}] enderchest.14 with iron_sword{clickable:1,HideFlags:63,KillWhenDropped:1,display:{Name:'{"text":"Exclusive Sword Name","color":"light_purple","italic":false,"bold":true}',Lore:['[{"text":"Unlocked!","italic":false,"color":"gold"}]']}}
...
item replace entity @s[advancements={custom/unlock_celebration=true}] enderchest.16 with dragon_egg{clickable:1,HideFlags:63,KillWhenDropped:1,display:{Name:'{"text":"Exclusive Celebration","color":"light_purple","italic":false,"bold":true}',Lore:['[{"text":"Unlocked!","italic":false,"color":"gold"}]']}}
