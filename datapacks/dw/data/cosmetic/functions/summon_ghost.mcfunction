execute if entity @a[gamemode=spectator,team=!spectator,tag=use_head] run summon bat ^ ^ ^5 {Silent:1b,Invulnerable:1b,ActiveEffects:[{Id:14b,Amplifier:1,Duration:10000,ShowParticles:0b}],Tags:["die","cosmetic_ghost"]}
...
execute if entity @a[gamemode=spectator,team=!spectator,tag=use_head] positioned ~2 ~ ~ run summon bat ^ ^ ^5 {Silent:1b,Invulnerable:1b,ActiveEffects:[{Id:14b,Amplifier:1,Duration:10000,ShowParticles:0b}],Tags:["die","cosmetic_ghost"]}
