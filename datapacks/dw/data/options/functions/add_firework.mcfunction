...
execute if score $time firework_time matches 0 run setblock 6 68 47 jungle_wall_sign[facing=west]{Text1:'{"text":"Firework","color":"blue","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}',Text2:'{"text":"spawn rate:","color":"blue","bold":true}',Text3:'{"text":"Slow","color":"yellow"}',Text4:'{"text":"<<<         >>>","color":"dark_purple","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:click_firework"}}'}
execute if score $time firework_time matches 1 run setblock 6 68 47 jungle_wall_sign[facing=west]{Text1:'{"text":"Firework","color":"blue","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}',Text2:'{"text":"spawn rate:","color":"blue","bold":true}',Text3:'{"text":"Normal","color":"yellow"}',Text4:'{"text":"<<<         >>>","color":"dark_purple","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:click_firework"}}'}
execute if score $time firework_time matches 2 run setblock 6 68 47 jungle_wall_sign[facing=west]{Text1:'{"text":"Firework","color":"blue","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}',Text2:'{"text":"spawn rate:","color":"blue","bold":true}',Text3:'{"text":"Fast","color":"yellow"}',Text4:'{"text":"<<<         >>>","color":"dark_purple","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 run function options:click_firework"}}'}
