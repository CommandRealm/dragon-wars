...
execute as @a[gamemode=adventure] at @s at @s[y=10,distance=..25] run particle dragon_breath ~ 0 ~ 10 0 10 0 20
...
execute if entity @a[x=-1000,y=66,z=0,distance=..400] run function hall_of_items:main
...
advancement grant @a[advancements={custom/unlock_prefix=false,custom/equip_elytra=true,custom/open_chest=true,custom/use_firework=true,custom/fall_off_lobby=true,custom/ride_dragon=true,custom/find_cr=true,custom/check_out_socials=true}] only minecraft:custom/unlock_prefix
