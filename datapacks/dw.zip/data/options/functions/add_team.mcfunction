...
execute if score $number team matches 1 run setblock -2 68 48 cherry_wall_sign[facing=north]{front_text:{messages:['{"text":"","color":"dark_purple","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}', '{"text":"Solos.","color":"dark_purple","bold":true}', '{"text":" ","color":"yellow"}', '{"text":"<<<         >>>","color":"dark_purple","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 if score $number mode matches ..2 run function options:click_team"}}']}}
execute if score $number team matches 2 run setblock -2 68 48 cherry_wall_sign[facing=north]{front_text:{messages:['{"text":"Number of","color":"dark_purple","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}', '{"text":"teams:","color":"dark_purple","bold":true}', '{"text":"2 teams.","color":"yellow"}', '{"text":"<<<         >>>","color":"dark_purple","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 if score $number mode matches ..2 run function options:click_team"}}']}}
execute if score $number team matches 3 run setblock -2 68 48 cherry_wall_sign[facing=north]{front_text:{messages:['{"text":"Number of","color":"dark_purple","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}', '{"text":"teams:","color":"dark_purple","bold":true}', '{"text":"3 teams.","color":"yellow"}', '{"text":"<<<         >>>","color":"dark_purple","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 if score $number mode matches ..2 run function options:click_team"}}']}}
execute if score $number team matches 4 run setblock -2 68 48 cherry_wall_sign[facing=north]{front_text:{messages:['{"text":"Number of","color":"dark_purple","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}', '{"text":"teams:","color":"dark_purple","bold":true}', '{"text":"4 teams.","color":"yellow"}', '{"text":"<<<         >>>","color":"dark_purple","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 if score $number mode matches ..2 run function options:click_team"}}']}}
execute if score $number team matches 5 run setblock -2 68 48 cherry_wall_sign[facing=north]{front_text:{messages:['{"text":"Number of","color":"dark_purple","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}', '{"text":"teams:","color":"dark_purple","bold":true}', '{"text":"5 teams.","color":"yellow"}', '{"text":"<<<         >>>","color":"dark_purple","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 if score $number mode matches ..2 run function options:click_team"}}']}}
