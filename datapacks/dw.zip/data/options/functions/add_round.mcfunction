...
execute unless score $round round_criteria matches 1 run setblock -6 68 47 jungle_wall_sign[facing=east]{Text1:'{"text":"Rounds","color":"red","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}',Text2:'{"text":"to win:","color":"red","bold":true}',Text3:'[{"score":{"objective":"round_criteria","name":"$round"},"color":"yellow"},{"text":" rounds.","color":"yellow"}]',Text4:'[{"text":"<<<         >>>","color":"dark_purple","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 if score $number mode matches ..2 run function options:click_round"}}]'}
execute if score $round round_criteria matches 1 run setblock -6 68 47 jungle_wall_sign[facing=east]{Text1:'{"text":"Rounds","color":"red","bold":true,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 1.. run function options:error"}}',Text2:'{"text":"to win:","color":"red","bold":true}',Text3:'[{"score":{"objective":"round_criteria","name":"$round"},"color":"yellow"},{"text":" round.","color":"yellow"}]',Text4:'[{"text":"<<<         >>>","color":"dark_purple","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score $game state matches 0 if score $number mode matches ..2 run function options:click_round"}}]'}
