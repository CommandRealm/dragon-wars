...
execute unless score $map map_select matches -2 run scoreboard players operation $map map = $map map_select
...
execute if score $number mode matches 3 run scoreboard objectives setdisplay sidebar rounds
...
execute if score $time chest_refill matches 0.. run bossbar add refill {"text":"Time until chests refill...","color":"gold","bold":false}
...
execute if score $map map matches -1 run tag @a[tag=playing] add played_on_map_15
advancement grant @a[tag=playing,tag=played_on_map_0,tag=played_on_map_1,tag=played_on_map_2,tag=played_on_map_3,tag=played_on_map_4,tag=played_on_map_5,tag=played_on_map_6,tag=played_on_map_7,tag=played_on_map_8,tag=played_on_map_9,tag=played_on_map_10,tag=played_on_map_11,tag=played_on_map_12,tag=played_on_map_13,tag=played_on_map_14,tag=played_on_map_15] only minecraft:custom/play_on_every_map
