...
advancement grant @a[tag=playing,tag=played_on_map_0,tag=played_on_map_1,tag=played_on_map_2,tag=played_on_map_3,tag=played_on_map_4,tag=played_on_map_5,tag=played_on_map_6,tag=played_on_map_7,tag=played_on_map_8,tag=played_on_map_9,tag=played_on_map_10,tag=played_on_map_11,tag=played_on_map_12,tag=played_on_map_13,tag=played_on_map_14,tag=played_on_map_15] only advancements:custom/play_on_every_map
