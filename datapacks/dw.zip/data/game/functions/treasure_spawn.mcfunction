...
execute at @e[tag=treasure_summon] if score $block treasure_time matches 5 run tellraw @a[tag=playing] [{"text":"-","color":"light_purple"},{"text":"=","color":"dark_purple"},{"text":"- ","color":"light_purple"},{"text":"An IRON BLOCK has appeared!","color":"white"}]
...
execute at @e[tag=treasure_summon] if score $block treasure_time matches 4 run tellraw @a[tag=playing] [{"text":"-","color":"light_purple"},{"text":"=","color":"dark_purple"},{"text":"- ","color":"light_purple"},{"text":"A GOLD BLOCK has appeared!","color":"gold"}]
...
execute at @e[tag=treasure_summon] if score $block treasure_time matches 3 run tellraw @a[tag=playing] [{"text":"-","color":"light_purple"},{"text":"=","color":"dark_purple"},{"text":"- ","color":"light_purple"},{"text":"A LAPIS BLOCK has appeared!","color":"dark_blue"}]
...
execute at @e[tag=treasure_summon] if score $block treasure_time matches 2 run tellraw @a[tag=playing] [{"text":"-","color":"light_purple"},{"text":"=","color":"dark_purple"},{"text":"- ","color":"light_purple"},{"text":"An EMERALD BLOCK has appeared!","color":"green"}]
...
execute at @e[tag=treasure_summon] if score $block treasure_time matches 1 run tellraw @a[tag=playing] [{"text":"-","color":"light_purple"},{"text":"=","color":"dark_purple"},{"text":"- ","color":"light_purple"},{"text":"A DIAMOND BLOCK has appeared!","color":"aqua"}]
