...
execute as @e[type=armor_stand,tag=striked_item] at @s unless data entity @s {ArmorItems:[{tag:{displayName:['{"text":""}']}}]} run tellraw @a ["",{"text":"🗡 ","color":"light_purple","bold":true},{"text":"The ","color":"gray"},{"nbt":"ArmorItems[0].tag.displayName[0]","entity":"@s","interpret": true},{"text":" "},{"nbt":"ArmorItems[0].tag.displayName2[0]","entity":"@s","interpret": true},{"text":" has been ","color":"gray"},{"text":"disabled","color":"red"},{"text":"!","color":"gray"}]
execute as @e[type=armor_stand,tag=striked_item] at @s if data entity @s {ArmorItems:[{tag:{displayName:['{"text":""}']}}]} run tellraw @a ["",{"text":"🗡 ","color":"light_purple","bold":true},{"text":"The ","color":"gray"},{"nbt":"ArmorItems[0].tag.displayName[0]","entity":"@s","interpret": true},{"nbt":"ArmorItems[0].tag.displayName2[0]","entity":"@s","interpret": true},{"text":" has been ","color":"gray"},{"text":"disabled","color":"red"},{"text":"!","color":"gray"}]
