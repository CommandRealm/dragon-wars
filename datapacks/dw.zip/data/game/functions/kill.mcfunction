advancement grant @a[scores={kill=1..},tag=playing] only minecraft:custom/get_a_kill
advancement grant @a[scores={kill=1..,gliding=1..},tag=playing] only minecraft:custom/get_a_kill_while_flying
...
advancement grant @a[scores={kill=1..,axe_dealt=1..},tag=playing,nbt={SelectedItem:{id:"minecraft:wooden_sword"}}] only minecraft:custom/kill_with_vampiric_stake
advancement grant @a[scores={kill=1..,axe_dealt=1..},tag=playing,nbt={SelectedItem:{id:"minecraft:iron_axe"}}] only minecraft:custom/kill_with_rage_axe
advancement grant @a[scores={kill=1..,axe_dealt=1..},tag=playing,nbt={SelectedItem:{id:"minecraft:iron_axe"}}] only minecraft:custom/kill_with_rage_axe
execute if entity @a[tag=give_treasure_advancement] run advancement grant @a[scores={kill=1..},tag=playing] only minecraft:custom/kill_player_with_treasure_blocks
