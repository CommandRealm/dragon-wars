...
execute if score $time timer matches 9800..9899 run function game:fight_text
...
execute unless score $time timer matches 9900.. as @a[tag=playing,scores={elytra=0},tag=!bar_symbol,gamemode=adventure] at @s run title @s actionbar [{"text":"Elytra equipped","color":"light_purple","underlined":true},{"text":" | ","color":"yellow","underlined":false},{"text":"Arrows","color":"red","underlined":false},{"text":": ","color":"gray","italic":false,"strikethrough": false,"underlined":false},{"score":{"objective":"arrow","name":"@s"},"color":"dark_red","underlined":false}]
execute unless score $time timer matches 9900.. as @a[tag=playing,scores={elytra=1..},tag=!bar_symbol,gamemode=adventure] at @s run title @s actionbar [{"text":"Elytra equipped","color":"dark_purple","strikethrough":true},{"text":" | ","color":"yellow","strikethrough":false},{"text":"Arrows","color":"red","strikethrough":false},{"text":": ","color":"gray","italic":false,"strikethrough": false,"underlined":false},{"score":{"objective":"arrow","name":"@s"},"color":"dark_red","strikethrough":false}]

execute unless score $time timer matches 9900.. as @a[tag=playing,scores={elytra=0},tag=bar_symbol,gamemode=adventure] at @s run title @s actionbar [{"text":"╔╗ ","color":"light_purple","underlined":false},{"text":" | ","color":"yellow","underlined":false},{"text":"➹ ","color":"red","underlined":false},{"text":": ","color":"gray","italic":false,"strikethrough": false,"underlined":false},{"score":{"objective":"arrow","name":"@s"},"color":"dark_red","underlined":false}]
execute unless score $time timer matches 9900.. as @a[tag=playing,scores={elytra=1..},tag=bar_symbol,gamemode=adventure] at @s run title @s actionbar [{"text":"╔╗ ","color":"dark_purple","strikethrough":true},{"text":" | ","color":"yellow","strikethrough":false},{"text":"➹ ","color":"red","strikethrough":false},{"text":": ","color":"gray","italic":false,"strikethrough": false,"underlined":false},{"score":{"objective":"arrow","name":"@s"},"color":"dark_red","strikethrough":false}]
...
execute unless score $time timer matches 9960.. if score $map map matches -1 as @a[tag=playing] at @s unless entity @s[x=17000,y=100,z=0,distance=..125] run tag @s add warning
...
# calculating when we need to update the bossbar
scoreboard players operation $20 chest_refill_t = $time chest_refill_t
scoreboard players operation $20 chest_refill_t %= $20 number
execute if score $20 chest_refill_t matches 0 run function game:update_chest_refill_boss_bar
...
# if phantom
execute if entity @e[type=minecraft:phantom] as @e[type=minecraft:phantom] run data merge entity @s {Fire:-200}