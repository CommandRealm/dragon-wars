...
tag @a[scores={treasure_sidebar=4..,death=1..}] add give_treasure_advancement
...
execute as @a[tag=playing,gamemode=adventure] at @s positioned as @e[type=item,nbt={Item:{tag:{Treasure:1}}},sort=nearest,limit=1] facing entity @s feet run function game:treasure_tracker