...
execute if entity @a[tag=toggle] run setblock 62 72 -13 jungle_wall_sign[facing=south]{Text1:'{"text":"Archery Prot","color":"dark_gray","bold":false}',Text2:'{"text":"Armor","color":"dark_gray","bold":false,"clickEvent":{"action":"run_command","value":"/function hall_of_items:archery_armor"}}',Text3:'{"text":"[ON]","color":"green"}',Text4:''}
execute unless entity @a[tag=toggle] run setblock 62 72 -13 jungle_wall_sign[facing=south]{Text1:'{"text":"Archery Prot","color":"dark_gray","bold":false}',Text2:'{"text":"Armor","color":"dark_gray","bold":false,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 0 run function hall_of_items:archery_armor"}}',Text3:'{"text":"[OFF]","color":"dark_red"}',Text4:''}
