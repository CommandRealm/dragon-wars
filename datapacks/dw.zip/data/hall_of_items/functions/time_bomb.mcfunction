...
execute if entity @a[tag=toggle] run setblock 65 72 -3 jungle_wall_sign[facing=north]{Text1:'{"text":"Time","color":"dark_gray","bold":false}',Text2:'{"text":"Bomb","color":"dark_gray","bold":false,"clickEvent":{"action":"run_command","value":"/function hall_of_items:time_bomb"}}',Text3:'{"text":"[ON]","color":"green"}',Text4:''}
execute unless entity @a[tag=toggle] run setblock 65 72 -3 jungle_wall_sign[facing=north]{Text1:'{"text":"Time","color":"dark_gray","bold":false}',Text2:'{"text":"Bomb","color":"dark_gray","bold":false,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 0 run function hall_of_items:time_bomb"}}',Text3:'{"text":"[OFF]","color":"dark_red"}',Text4:''}
