...
execute if entity @a[tag=toggle] run setblock 61 72 -3 jungle_wall_sign[facing=north]{Text1:'{"text":"Swapper","color":"red","bold":false}',Text2:'{"text":"Beam","color":"red","bold":false,"clickEvent":{"action":"run_command","value":"/function hall_of_items:tp_beam"}}',Text3:'{"text":"[ON]","color":"green"}',Text4:''}
execute unless entity @a[tag=toggle] run setblock 61 72 -3 jungle_wall_sign[facing=north]{Text1:'{"text":"Swapper","color":"red","bold":false}',Text2:'{"text":"Beam","color":"red","bold":false,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 0 run function hall_of_items:tp_beam"}}',Text3:'{"text":"[OFF]","color":"dark_red"}',Text4:''}
