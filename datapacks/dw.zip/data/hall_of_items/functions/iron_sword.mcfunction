...
execute if entity @a[tag=toggle] run setblock 53 72 -13 jungle_wall_sign[facing=south]{Text1:'',Text2:'{"text":"Iron Sword","color":"white","bold":false,"clickEvent":{"action":"run_command","value":"/function hall_of_items:iron_sword"}}',Text3:'{"text":"[ON]","color":"green"}',Text4:''}
execute unless entity @a[tag=toggle] run setblock 53 72 -13 jungle_wall_sign[facing=south]{Text1:'',Text2:'{"text":"Iron Sword","color":"white","bold":false,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 0 run function hall_of_items:iron_sword"}}',Text3:'{"text":"[OFF]","color":"dark_red"}',Text4:''}
