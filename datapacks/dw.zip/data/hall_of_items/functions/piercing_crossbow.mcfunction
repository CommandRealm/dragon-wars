...
execute if entity @a[tag=toggle] run setblock 58 72 -3 cherry_wall_sign[facing=north]{front_text:{messages:['{"text":"Piercing","color":"red","bold":false}', '{"text":"Crossbow","color":"red","bold":false,"clickEvent":{"action":"run_command","value":"/function hall_of_items:piercing_crossbow"}}', '{"text":"[ON]","color":"green"}', '{"text":""}']}}
execute unless entity @a[tag=toggle] run setblock 58 72 -3 cherry_wall_sign[facing=north]{front_text:{messages:['{"text":"Piercing","color":"red","bold":false}', '{"text":"Crossbow","color":"red","bold":false,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 0 run function hall_of_items:piercing_crossbow"}}', '{"text":"[OFF]","color":"dark_red"}', '{"text":""}']}}
