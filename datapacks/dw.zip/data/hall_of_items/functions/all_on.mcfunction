...
tellraw @s ["",{"text":"🗡 ","color":"light_purple","bold":true},{"text":"All items are on.","color":"green"}]
tag @p add toggle
...
# comp update items
tag @p add toggle
function hall_of_items:sniping_bow
tag @p add toggle
function hall_of_items:thief_beam
tag @p add toggle
function hall_of_items:hyperspeed_potion
tag @p add toggle
function hall_of_items:strength_shield
tag @p add toggle
function hall_of_items:firework_shield
tag @p add toggle
function hall_of_items:reflector
