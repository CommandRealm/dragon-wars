...
execute if entity @a[tag=toggle] run setblock 66 72 -3 jungle_wall_sign[facing=north]{Text1:'{"text":"Egg of","color":"yellow","bold":false}',Text2:'{"text":"Slow Falling","color":"yellow","bold":false,"clickEvent":{"action":"run_command","value":"/function hall_of_items:egg_of_slow_falling"}}',Text3:'{"text":"[ON]","color":"green"}',Text4:''}
execute unless entity @a[tag=toggle] run setblock 66 72 -3 jungle_wall_sign[facing=north]{Text1:'{"text":"Egg of","color":"yellow","bold":false}',Text2:'{"text":"Slow Falling","color":"yellow","bold":false,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 0 run function hall_of_items:egg_of_slow_falling"}}',Text3:'{"text":"[OFF]","color":"dark_red"}',Text4:''}
