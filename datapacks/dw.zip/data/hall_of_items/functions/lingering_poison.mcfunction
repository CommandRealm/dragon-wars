...
execute if entity @a[tag=toggle] run setblock 71 72 -3 jungle_wall_sign[facing=north]{Text1:'{"text":"Lingering Potion","color":"green","bold":false}',Text2:'{"text":"of Poison","color":"green","bold":false,"clickEvent":{"action":"run_command","value":"/function hall_of_items:lingering_poison"}}',Text3:'{"text":"[ON]","color":"green"}',Text4:''}
execute unless entity @a[tag=toggle] run setblock 71 72 -3 jungle_wall_sign[facing=north]{Text1:'{"text":"Lingering Potion","color":"green","bold":false}',Text2:'{"text":"of Poison","color":"green","bold":false,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 0 run function hall_of_items:lingering_poison"}}',Text3:'{"text":"[OFF]","color":"dark_red"}',Text4:''}
