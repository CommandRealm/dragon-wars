...
execute if entity @a[tag=toggle] run setblock 69 72 -13 cherry_wall_sign[facing=south]{front_text:{messages:['{"text":"Basic","color":"gray","bold":false}', '{"text":"Shield","color":"gold","bold":false,"clickEvent":{"action":"run_command","value":"/function hall_of_items:shield"}}', '{"text":"[ON]","color":"green"}', '{"text":""}']}}
execute unless entity @a[tag=toggle] run setblock 69 72 -13 cherry_wall_sign[facing=south]{front_text:{messages:['{"text":"Basic","color":"gray","bold":false}', '{"text":"Shield","color":"gold","bold":false,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 0 run function hall_of_items:shield"}}', '{"text":"[OFF]","color":"dark_red"}', '{"text":""}']}}
