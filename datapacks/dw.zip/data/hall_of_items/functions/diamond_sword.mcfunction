...
execute if entity @a[tag=toggle] run setblock 54 72 -13 cherry_wall_sign[facing=south]{front_text:{messages:['{"text":""}', '{"text":"Diamond Sword","color":"aqua","bold":false,"clickEvent":{"action":"run_command","value":"/function hall_of_items:diamond_sword"}}', '{"text":"[ON]","color":"green"}', '{"text":""}']}}
execute unless entity @a[tag=toggle] run setblock 54 72 -13 cherry_wall_sign[facing=south]{front_text:{messages:['{"text":""}', '{"text":"Diamond Sword","color":"aqua","bold":false,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 0 run function hall_of_items:diamond_sword"}}', '{"text":"[OFF]","color":"dark_red"}', '{"text":""}']}}
