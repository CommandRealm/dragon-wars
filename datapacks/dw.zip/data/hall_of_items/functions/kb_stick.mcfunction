...
execute if entity @a[tag=toggle] run setblock 59 72 -13 cherry_wall_sign[facing=south]{front_text:{messages:['{"text":"Knockback","color":"yellow","bold":false}', '{"text":"Stick","color":"yellow","bold":false,"clickEvent":{"action":"run_command","value":"/function hall_of_items:kb_stick"}}', '{"text":"[ON]","color":"green"}', '{"text":""}']}}
execute unless entity @a[tag=toggle] run setblock 59 72 -13 cherry_wall_sign[facing=south]{front_text:{messages:['{"text":"Knockback","color":"yellow","bold":false}', '{"text":"Stick","color":"yellow","bold":false,"clickEvent":{"action":"run_command","value":"/execute if score $game state matches 0 run function hall_of_items:kb_stick"}}', '{"text":"[OFF]","color":"dark_red"}', '{"text":""}']}}
