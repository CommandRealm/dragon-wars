...
item replace entity @s armor.legs with leather_leggings{HideFlags:63,KillOnDeath:1,display:{color:8961023,Name:'{"italic":false,"bold":true,"color":"dark_aqua","text":"Ninja Leggings"}'},Enchantments:[{id:"binding_curse",lvl:1}],AttributeModifiers:[{AttributeName:"generic.movement_speed", Name:"generic.movement_speed", Amount:0.025, Operation:0, UUID:[I; 5, 5, 5, 5]},{AttributeName:"generic.armor", Name:"generic.armor", Amount:2.0, Operation:0, UUID:[I; 6, 6, 6, 6]}],Unbreakable:1b}
item replace entity @s armor.feet with leather_boots{KillOnDeath:1,display:{color:8961023,Name:'{"italic":false,"bold":true,"color":"dark_aqua","text":"Ninja Boots"}'},Enchantments:[{id:"binding_curse",lvl:1}],HideFlags:63,Unbreakable:1b}
