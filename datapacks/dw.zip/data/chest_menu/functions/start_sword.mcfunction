...
item replace entity @s[tag=!sword_secret] enderchest.21 with red_stained_glass_pane{KillWhenDropped:1,display:{Lore:['{"text":"Legendary","color":"gold","italic":false}','{"text":"Locked","color":"red","italic":false}'],Name:'{"text":"Super Secret Winners","color":"yellow","italic":false,"bold":true}'}}
item replace entity @s[tag=sword_secret] enderchest.21 with orange_stained_glass_pane{KillWhenDropped:1,display:{Lore:['{"text":"Legendary","color":"gold","italic":false}'],Name:'{"text":"Super Secret Winners","color":"light_purple","italic":false,"bold":true}'},ChestSword:18}
item replace entity @s[scores={sword=21}] enderchest.21 with blue_stained_glass_pane{KillWhenDropped:1,display:{Lore:['{"text":"Legendary","color":"gold","italic":false}','{"text":"Selected","color":"blue","italic":false}'],Name:'{"text":"Super Secret Winners","color":"light_purple","italic":false,"bold":true}'}}

item replace entity @s[tag=!sword_pulled] enderchest.22 with red_stained_glass_pane{KillWhenDropped:1,display:{Lore:['{"text":"Legendary","color":"gold","italic":false}','{"text":"Locked","color":"red","italic":false}'],Name:'{"text":"Ok I pulled up","color":"yellow","italic":false,"bold":true}'}}
item replace entity @s[tag=sword_pulled] enderchest.22 with orange_stained_glass_pane{KillWhenDropped:1,display:{Lore:['{"text":"Legendary","color":"gold","italic":false}'],Name:'{"text":"Ok I pulled up","color":"light_purple","italic":false,"bold":true}'},ChestSword:19}
item replace entity @s[scores={sword=20}] enderchest.22 with blue_stained_glass_pane{KillWhenDropped:1,display:{Lore:['{"text":"Legendary","color":"gold","italic":false}','{"text":"Selected","color":"blue","italic":false}'],Name:'{"text":"Ok I pulled up","color":"light_purple","italic":false,"bold":true}'}}

item replace entity @s[tag=!sword_combo] enderchest.23 with red_stained_glass_pane{KillWhenDropped:1,display:{Lore:['{"text":"Legendary","color":"gold","italic":false}','{"text":"Locked","color":"red","italic":false}'],Name:'{"text":"Combo Weapon","color":"yellow","italic":false,"bold":true}'}}
item replace entity @s[tag=sword_combo] enderchest.23 with orange_stained_glass_pane{KillWhenDropped:1,display:{Lore:['{"text":"Legendary","color":"gold","italic":false}'],Name:'{"text":"Combo Weapon","color":"light_purple","italic":false,"bold":true}'},ChestSword:20}
item replace entity @s[scores={sword=19}] enderchest.23 with blue_stained_glass_pane{KillWhenDropped:1,display:{Lore:['{"text":"Legendary","color":"gold","italic":false}','{"text":"Selected","color":"blue","italic":false}'],Name:'{"text":"Combo Weapon","color":"light_purple","italic":false,"bold":true}'}}

item replace entity @s[tag=has_tournament] enderchest.26 with netherite_sword{HideFlags:63,KillWhenDropped:1,display:{Name:'{"text":"Tournament Sword Names","color":"gold","italic":false}'}}
