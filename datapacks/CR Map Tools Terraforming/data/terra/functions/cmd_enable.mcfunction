...
tellraw @p ["",{"text":">","bold":true,"color":"green"},{"text":" [Sphere Tool]:","bold":true,"color":"blue"},{"text":" (Snowball) ","color":"gold"},{"text":"Throwing a Snowball creates a massive yellow sphere that replaces air.","color":"yellow"}]
